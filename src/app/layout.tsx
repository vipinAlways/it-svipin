...
export const metadata: Metadata = {
  title: "Vipin",
  description:
    "Explore Vipin's personal portfolio, web projects, and design work. Frontend developer with a passion for building interactive experiences.",
  keywords: [
    "Vipin",
    "Web Developer",
    "Frontend Developer",
  ...
  openGraph: {
    ...
    description:
      "Discover the portfolio of Vipin, a frontend developer focused on building modern, responsive, and creative websites.",
